 import { Component, AfterViewInit, OnDestroy, ViewChild, Inject, PLATFORM_ID, ChangeDetectorRef } from '@angular/core';
// import 'jquery';
...
// import { NgbDateStruct, NgbModal, NgbModalConfig, NgbModule } from '@ng-bootstrap/ng-bootstrap';
...
@Component({
  ...
  standalone:true,
  // imports:[DataTablesModule,DecimalPipe,AccordionModule,DatePipe,
  //     TabsModule,SweetAlert2Module,NgSelectModule,ReactiveFormsModule,
  //     CommonModule,FormsModule,NgbModule,TooltipModule],
  // providers:[DataTablesModule]
})
...
//     table1: any;
//   loginUserName ='veerender.kumar-e@maf.ae';
...
//     this.dataTable = $('#tblBookingOverview').DataTable({
//       "order": [[5, "asc"]],
//       "dom": '<lf<t>ip>',
//       pageLength: 100,
//       destroy: true,
...
//   changedYear(event: any): void {
//     const selectedYear = event.target.value;
//     this.isLoader = true;

//     this.GetBudgetTrackingData(selectedYear)
//       .then((data) => {
//         this.initializeDataTable(data); // Refresh the DataTable with new data
//         this.isLoader = false;
//       })
//       .catch((error) => {
...
//   GetBudgetTrackingData(year: string): Promise<any[]> {
//     return new Promise((resolve, reject) => {
//       // Replace with your service call
//       this.service.getBudgetTrackingData(year, this.loginUserName.toLowerCase()).subscribe(
//         (res:any) => resolve(res),
//         (err:any) => reject(err)
//       );
//     });
...
//         this.GetBudgetTrackingData(this.searchYear.controls["year"].value);
//     //   }
//     // });
//   }
