...
import { PoetClass,GetPoetDTO } from "./app/views/dashboard/PoetClass";
import { User } from "./app/views/theme/Users";
import { cmbUser } from "./app/views/theme/Users";
import { MonthClass } from "./app/views/dashboard/MonthClass";
import { Dashboard, BudgetUserYear, UpdatePOAmount, AddPOAmount, UpdateChange } from "./app/views/dashboard/masterPoetClass";
import { BudgetBooking } from "./app/views/dashboard/budgetBookingClass";
import { BudgetBookingLines } from "./app/views/dashboard/budgetBookingClass";
...
export class ApiService {
  ...
  public getUsers() {
    return this.http.get(this.Root_URL + "common/v1/getUsers");
  }
  getUserDetails() {
  ...
  public getUserBudgetData(user:any) {
    return this.http.post(this.Root_URL + "dashboard/v1/showUserBudgetData", user);
  }
  ...
  getBudgetTrackingData(year: String, email: String) {
    ...
    objGetPoetDTO.year = year;
    objGetPoetDTO.email = email;
    return this.http.post(this.Root_URL + "budgeTracking/v1/get", objGetPoetDTO);
  }
  ...
  spendMonthlyWise(objDashboard: Dashboard) {
    return this.http.post(this.Root_URL + "dashboard/v1/spendMonthlyWise", objDashboard);
  }

  budgetBalance(objDashboard: Dashboard) {
    return this.http.post(this.Root_URL + "dashboard/v1/budgetBalance", objDashboard);
  }

  functionOverview(objDashboard: Dashboard) {
    return this.http.post(this.Root_URL + "dashboard/v1/functionOverview", objDashboard);
  }

  functionL2Overview(objDashboard: Dashboard) {
    return this.http.post(this.Root_URL + "dashboard/v1/functionL2Overview", objDashboard);
  }
